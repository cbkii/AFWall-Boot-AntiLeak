#!/system/bin/sh
# AFWall Boot AntiLeak v4.4.4 — installer/reconfigure config helper.
...
_ic_select_profile() {
    _ic_print ""
    _ic_print "  v4.4.4 profiles: standard, minimal, strict, recovery, custom"
...
#!/system/bin/sh
# AFWall Boot AntiLeak v4.4.4 local overrides.  Generated by installer/reconfigure.
...
ic_render_summary() {
    _ic_print ""
    _ic_print "  ── v4.4.4 Configuration Summary ─────────────────────"
