#!/system/bin/sh
# AFWall Boot AntiLeak v4.3.1 — installer/reconfigure config helper.
...
_ic_select_profile() {
    _ic_print ""
    _ic_print "  v4.3.1 profiles: standard, minimal, strict, recovery, custom"
...
#!/system/bin/sh
# AFWall Boot AntiLeak v4.3.1 local overrides.  Generated by installer/reconfigure.
...
ic_render_summary() {
    _ic_print ""
    _ic_print "  ── v4.3.1 Configuration Summary ─────────────────────"
...
ic_run_config_selection() {
    ...
    ic_apply_defaults
    _ic_print ""
    _ic_print "  v4.3.1 is a breaking config cleanup release."
